...
al_rdf = IPFitting.Data.read_xyz(@__DIR__() * "/DB_10.xyz", energy_key="energy", force_key="force")
R = minimum(IPFitting.Aux.rdf(al_rdf, 5.0));
...
for i in 1:11
    ...
    save_dict(@__DIR__() * "/Ti_NRLTB_surf_3_N3_16_DB$(i).json", Dict("IP" => write_dict(IP), "info" => lsqinfo))
end
