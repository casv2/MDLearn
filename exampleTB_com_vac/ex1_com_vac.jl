...
function plot_HMD(E_tot, E_pot, E_kin, T, P, i; k=50) # varEs,
    ...
    savefig("./exampleTB_com_vac/HMD_$(i).pdf")
end
...
function do_fit(al)
    ...
    c_samples = MDLearn.Uncertain.do_brr(Ψ, Y, 20.0, 5.0, 3);
...
init_at = IPFitting.Data.read_xyz(@__DIR__() * "/hcp_vac.xyz")[1].at
...
for i in 1:10
    ...
    write_xyz("./exampleTB_com_vac/crash_$(i).xyz", cfgs[end])
    run(`/Users/Cas/anaconda2/bin/python /Users/Cas/.julia/dev/MDLearn/exampleTB_com_vac/convert.py $(i)`)
end
